...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public AuthenticationProvider authenticationProvider() {
        final ECommerceAuthenticationProvider authenticationProvider = new ECommerceAuthenticationProvider();
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/seller/list").permitAll()
                .antMatchers("/seller/delete/{username}").permitAll()
                .antMatchers("/seller/{username}").permitAll()

                .antMatchers("/register/customer").permitAll()
                .antMatchers("/customer/list").permitAll()
                .antMatchers("/customer/delete/{username}").permitAll()
                .antMatchers("/customer/{username}").permitAll()
                .antMatchers("/activate/customer/{token}").permitAll()
                .antMatchers("/customer/resendActivationLink/{email}").permitAll()
